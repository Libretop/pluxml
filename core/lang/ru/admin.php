...
'L_THUMBNAIL'												=> 'приложенные документы или заглавное изображение (необязательно)',
'L_THUMBNAIL_SELECTION'										=> 'Выбрать Изображение',
'L_THUMBNAIL_TITLE'											=> 'Название заглавного изображения или документа (необязательно)',
'L_THUMBNAIL_ALT'											=> 'Текст для параметра alt изображения (необязательно)',
'L_ERR_INVALID_DATE_CREATION'								=> 'Проблема с датой создания',
'L_ERR_INVALID_DATE_UPDATE'									=> 'Проблема с датой обновления',
...
'L_HEADLINE_FIELD'											=> 'Краткое содержание (необязательно)',
